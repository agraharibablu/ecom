    ...
    <div class="category-section">
        <div class="container-fluid2">
            ...
            <div class="row mt-5">
                <div class="col-md-3">
                    <div class="img-box">
                        <img src="{{asset('frontend/image/category/img-4.jpg')}}" class="img-fluid" alt="">
                    </div>
    ...
    <div class="shop-section">
        <div class="container-fluid2">
            ...
            <div class="row mt-5">
                <div class="col-md-3">
                    <a href="#">
                        <div class="shop-box bg-1">
                            <div class="shop-img">
                                <img src="{{asset('frontend/image/shop/Turkey-Front.png')}}" class="img-fluid" alt="">
                            </div>
                        </div>
                    </a>
                ...
                <div class="col-md-3">
                    <a href="#">
                        <div class="shop-box bg-2">
                            <div class="shop-img">
                                <img src="{{asset('frontend/image/shop/Shitake-Front.png')}}" class="img-fluid" alt="">
                            </div>
                        </div>
                    </a>
                ...
                <div class="col-md-3">
                    <a href="#">
                        <div class="shop-box bg-3">
                            <div class="shop-img">
                                <img src="{{asset('frontend/image/shop/Chaga-Front.png')}}" class="img-fluid" alt="">
                            </div>
                        </div>
                    </a>
                </div>
